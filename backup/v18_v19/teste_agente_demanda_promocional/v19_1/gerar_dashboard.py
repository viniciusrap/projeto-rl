...
if __name__ == '__main__':
    ...
    path_cal = PROJETO / 'results' / 'v19_1' / 'calendario_v19_1.json'
    path_html = PROJETO / 'results' / 'v19_1' / 'dashboard_v19_1.html'

    gerar_dashboard(str(path_cal), str(path_html))
    print(f"✓ Dashboard V19.1 salvo: {path_html}")
