...
for step in range(n_steps):
    ...
    # Estado pré-step (step muta data_atual/turno)
...
for c in campanhas:
    ...
    # Combo: par DINÂMICO (calculado pelo env, top-1 fator contextual)
    # — em vez do par estático heurístico em cat_cfg['par_combo']
    if intens == 3:
