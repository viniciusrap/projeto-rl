"""Gera HTML premium do calendário V4 (modelo V12.1) — adaptado.

Output: results/v12/calendario_premium_v12.html
"""
import io
import json
import sys
...
V11 = ROOT / 'results' / 'v12'  # aponta para v12

TOP_N = 15
AUTO_REFRESH_SEGUNDOS = 0

candidatos = [V11 / 'calendario_v4_anual.json',
              V11 / 'calendario_v4.json',
              V11 / 'calendario_v4_v12_1.json']
candidatos = [p for p in candidatos if p.exists()]
if not candidatos:
    raise FileNotFoundError('Nenhum calendario_v4*.json em results/v12/')
...
<div class="container">
  ...
  <div class="header">
    ...
    <div class="subtitle">
      Auto Posto Parque Viana · Modelo V12.1 (cigarros NPM + K_EVENTO_PRESENTE + harmonia)<br>
...
html += f'''
  ...
  <footer>
    <p><strong>Modelo V12.1</strong> — DQN com forecaster ML + cigarros NPM (Lei 9.294/96) + K_EVENTO_PRESENTE=600 + harmonia categorial (62 pares) + harmonia evento→puxador (19 eventos)</p>
...
(V11 / 'calendario_premium_v12.html').write_text(html, encoding='utf-8')

print(f"✓ {V11 / 'calendario_premium_v12.html'}")
print()
...
print()
print(f"Para abrir: start {V11 / 'calendario_premium_v12.html'}")
